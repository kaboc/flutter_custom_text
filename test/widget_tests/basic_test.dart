...
void main() {
  ...
  group('How updates of properties affect appearance', () {
  ...
  group('How updates of properties affect behaviours', () {
    testWidgets(
      'Changing definition (except for matcher) causes a rebuild '
